...
with open('D:/Università/Optimization for AI/pokemon_evo_alg/pokemon_python/data/abilities.json') as f:
    abilities_raw_data = json.load(f)
with open('D:/Università/Optimization for AI/pokemon_evo_alg/pokemon_python/data/formats.json') as f:
    formats_raw_data = json.load(f)
with open('D:/Università/Optimization for AI/pokemon_evo_alg/pokemon_python/data/items.json') as f:
    items_raw_data = json.load(f)
with open('D:/Università/Optimization for AI/pokemon_evo_alg/pokemon_python/data/moves.json') as f:
    moves_raw_data = json.load(f)
with open('D:/Università/Optimization for AI/pokemon_evo_alg/pokemon_python/data/pokedex.json') as f:
    pokemon_raw_data = json.load(f)
with open('D:/Università/Optimization for AI/pokemon_evo_alg/pokemon_python/data/typechart.json') as f:
    typecharts_raw_data = json.load(f)
with open('D:/Università/Optimization for AI/pokemon_evo_alg/pokemon_python/data/natures.json') as f:
    natures_raw_data = json.load(f)
with open('D:/Università/Optimization for AI/pokemon_evo_alg/pokemon_python/data/simple_learnsets.json') as f:
    simple_learnsets = json.load(f)
with open('D:/Università/Optimization for AI/pokemon_evo_alg/pokemon_python/data/sample_teams.json') as f:
    sample_teams = json.load(f)
with open('D:/Università/Optimization for AI/pokemon_evo_alg/pokemon_python/data/domains/all.json') as f:
